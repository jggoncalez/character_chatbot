...
O projeto é implantado como **dois serviços independentes** no [Railway](https://railway.app):

| Serviço | Runtime | Comando de início |
|---|---|---|
...
### Variáveis de ambiente (painel Railway)
...
PORT=3000 (ou padrão do Railway)
```
